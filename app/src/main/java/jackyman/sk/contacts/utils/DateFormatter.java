...
public class DateFormatter {
    ...
    public static final String Format_DD_MM_YY = "dd/MM/yyyy";
    ...
    public static Long getLongFromString(String date, String format) {
        if (date == null)
            return null;
        try {
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat(format);
    ...
    public static Calendar getDate(long milliSeconds, String dateFormat)
    {
