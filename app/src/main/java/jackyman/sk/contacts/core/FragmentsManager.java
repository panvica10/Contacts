...
import jackyman.sk.contacts.ui.fragments.BaseFragment;
...
//    private void switchFragmentInHome(BaseFragment fragment,  LinkedList<BaseFragment> backStack, String backStackName, int layoutId) {
//        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
//        Fragment top = null;
//
//        transaction.add(layoutId, fragment)
...
//    }
    ...
    public void clearTopFragmentInMainBackstack(){
        if (mainBackStack.size() >= 1){
            mainBackStack.remove(mainBackStack.size()-1);
        }
    }
